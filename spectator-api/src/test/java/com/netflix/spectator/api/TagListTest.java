...
public class TagListTest {
    ...
    public void testCreateIterable() {
        TagList tags = TagList.create(Arrays.asList(Tag.of("a", "v1"), Tag.of("b", "v2"), Tag.of("c", "v3")));
        assertEquals(3, tags.size());
        assertEquals(Tag.of("a", "v1"), tags.getTag(0));
        assertEquals(Tag.of("b", "v2"), tags.getTag(1));
        assertEquals(Tag.of("c", "v3"), tags.getTag(2));
    ...
    public void testCreateIterableContravariance() {
        List<CustomTag> customTags = Arrays.asList(CustomTag.of("a", "v1"), CustomTag.of("b", "v2"), CustomTag.of("c", "v3"));
    ...
    public void testCollector() {
        TagList tags = Stream.of(Tag.of("a", "v1"), Tag.of("b", "v2"), Tag.of("c", "v3")).collect(
                TagList.toTagList());
        assertEquals(3, tags.size());
        assertEquals(TagList.create(Arrays.asList(Tag.of("c", "v3"), Tag.of("b", "v2"), CustomTag.of("a", "v1"))), tags);
    }
